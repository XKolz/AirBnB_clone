...
```bash
git clone https://github.com/XKolz/AirBnB_clone
```
...
## Authors
<details>
    <summary>Oladapo Timothy Popoola</summary>
    <ul>
    <li><a href="https://github.com/polham50">Github</a></li>
    <li><a href="mailto:oladapotimothy2016@gmail.com">e-mail</a></li>
    </ul>
</details>
<details>
    <summary>Samuel Igbekele</summary>
    <ul>
    <li><a href="https://github.com/XKolz">Github</a></li>
    <li><a href="mailto:samuelayo61@gmail.com">e-mail</a></li>
    </ul>
</details>
